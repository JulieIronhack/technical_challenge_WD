...
function PhoneDetail() {
  ...
  return (
    <>
       ...
       (
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-3 text-center mt-6">
        <div class="p-5">
          <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-[32px]">{phoneDetail[0].name}</h5>
        </div>
        ...
        <div class="p-5">
          ...
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Ram: {phoneDetail[0].ram}gb</p>
