...
function PhoneDetail() {
  ...
  return (
    <>
      {!phone ? (<div className='p-10 text-center justify-center'><svg aria-hidden="true" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-green-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex justify-center mt-20">
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                ...
                <div className="card-text"><small className="text-body-secondary"><b>Price: </b> {phone.price}  €</small></div>
              </div>
            </div>
          </div>
        </>
