...
// const DB_NAME = 'phones'

// try {
//     execSync(`mongoimport --db ${DB_NAME} --collection workshop --drop --file "${process.cwd()}/data/seed/phones.json" ---jsonArray `);
//     console.log(`Imported docuemnts into database ${DB_NAME}`)

// } catch (err) {
//     console.log(`Could not import docuemnts into databe ${DB_NAME}`);
//     console.log(err)
// }

const mongoose = require('mongoose')
const Phone = require('../models/Phone.model')
const MONGO_URI = 'mongodb://localhost/phones'
...
Phone
    .create(phones)
    .then(phoneToDB => {
        console.log(`Estoy creando una nueva DB con  ${phoneToDB.length}`);
